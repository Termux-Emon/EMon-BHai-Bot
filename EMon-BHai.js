...
exec("rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("EMon-BHai (EMON HAWLADAR) ❯ ") + chalk.hex("#00ffff")("fixed by EMon-BHai (EMON HAWLADAR)"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ EMon-BHai (EMON HAWLADAR) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/Termux-Emon/EMon-BHai-Bot/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/Termux-Emon/EMon-BHai-Bot/main/listban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Termux-Emon/EMon-BHai-Bot/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`EMon-BHai`, '[ EMon-BHai (EMON HAWLADAR) ]');
        logger('Hey, thank you for using this Bot', '[ EMon-BHai (EMON HAWLADAR) ]');
        logger("Fixed by EMon-BHai", '[ EMon-BHai (EMON HAWLADAR) ]');
